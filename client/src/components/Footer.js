          ...
          <Row className="footer-links-row">
            <Col xs={12} sm={6} md={4} lg={2} className="footer-col">
              ...
              <ul className="footer-list">
                <li>
                  <Link to={STORE_ROUTE}>All Products</Link>
                </li>
                <li>
                  <Link to={STORE_ROUTE}>New Arrivals</Link>
                </li>
                <li>
                  <Link to={STORE_ROUTE}>Best Sellers</Link>
                </li>
                <li>
                  <Link to={STORE_ROUTE}>Special Offers</Link>
                </li>
              </ul>
            </Col>
            ...
            <Col xs={12} sm={6} md={4} lg={2} className="footer-col">
              ...
              <ul className="footer-list">
                ...
                <li>
                  <Link to={BASKET_ROUTE}>My Basket</Link>
                </li>
                <li>
            ...
            <Col xs={12} sm={6} md={4} lg={2} className="footer-col">
              ...
              <ul className="footer-list">
                <li>
                  <Link to={INDEX_ROUTE}>About Us</Link>
                </li>
                <li>
        ...
        <Container>
          <div className="footer-bottom-inner">
            ...
            <p className="footer-copy">
              &copy; 2026 Online Store. All rights reserved.
            </p>
